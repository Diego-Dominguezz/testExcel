...
function paginate($reload, $page, $tpages, $adjacents) {
	...
	$url = "url_str,";
	$mostrar = "document.getElementById('select_lista_viajes').value,";
	$ordenar = "document.getElementById('select_order_viajes').value,";
	$searchby = "document.getElementById('searchby_select').value,";
	$filtro = "document.getElementById('contenido_busqueda').value";
	$varpag = $url. $mostrar . $ordenar . $searchby . $filtro;
	// previous label
